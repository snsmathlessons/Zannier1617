...
sorgente, infatti ho importato il pacchetto opportuno \notamargine{Per
  quanto riguarda utilizzare altri pacchetti, segnalatelo prima di
  usarli visto che potrebbero dare problemi nella compilazione, che
  viene effettuata in remoto} che ci consente di inserire àèìòùy come se
fosse antani e verranno visualizzate bene nel file.
...
fatto importante o subdolo che potrebbe sfuggire. \notamargine{Le note a
  piè di pagina inserite con footnote vengono automaticamente messe al
  lato di dove le avete inserite}
...
%\begin{tikzpicture}
%  \scalebox{0.3}{
%    \begin{pspicture*}[Dx=5, Dy=5](-3, -3)(3, 3)
%      \psplotImp[algebraic,linecolor=black,linewidth=0.3pt,stepFactor=0.2](-1.5,-1.5)(1.5,1.5){y^2 - x^3 - 1.3*x^2}
%    \end{pspicture*}
%  }
%\end{tikzpicture}

\curvegraph{y**2 - x**3 - x**2}{[-4:4]}{[-4:4]}
