\thislesson{26 Settembre 2016}{Esempi di superfici di Riemann e inizio della classificazione}
...
\begin{enumerate}
  ...
  \item Curve algebriche non singolari in $\bbP^2(\bbC)$ ($\{(x:y:z)\in \bbP^2(\bbC) | \ f(x,y,z)=0\}$, dove $f\in \bbC[x,y,z]$ è un polinomio irriducibile (compatta). %TODO Dimstrazione.
\end{enumerate}
