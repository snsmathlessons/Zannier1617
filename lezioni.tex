...
\usepackage{amsthm}
  ...
  \newcounter{escounter}
    ...
    \newtheorem{esempio}[escounter]{Esempio}
...
\part{Superfici di Riemann}
\input{parti/sdr-def.tex}
\input{parti/sdr-aut.tex}
\input{parti/sdr-tori.tex}

\part{Curve ellittiche}
\input{parti/fell-weierstrass.tex}
\input{parti/fell-curve.tex}
\input{parti/fell-gruppo.tex}
\input{parti/fell-raz.tex}
\input{parti/fell-cose.tex}

\part{Forme modulari}
\input{parti/fmod.tex}


\appendix
\part{Extra}
\input{parti/appendice-geomalg}
\input{parti/appendice-domande}
\input{parti/appendice-esercizi-svolti}
